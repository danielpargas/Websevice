...
//Se inicializan los atributos para el Select            
    ...
    //Condicion que establece que para obtener el status del animal
...
if ($error) {
    $mensaje["estatus"] = 0;
    $mensaje["mensaje"] = "Ocurrio un error al Obtener el status de la donacion";
} else {
//Caso contrario es 1    
    $mensaje["estatus"] = 1;
    $mensaje["mensaje"] = "Status de la donacion obtenido con Exito";
}
